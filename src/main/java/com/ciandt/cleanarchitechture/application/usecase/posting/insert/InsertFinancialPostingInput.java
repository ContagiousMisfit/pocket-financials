...
@Getter
public class InsertFinancialPostingInput {
    ...
    public InsertFinancialPostingInput(LocalDate date, String description, BigDecimal value, boolean isActive, Long userId, Long postingTypeId) {
